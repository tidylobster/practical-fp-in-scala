...
case class RetryPolicy[M[_]](
  ...
  /** Combine this schedule with another schedule, giving up when both of the schedules want to give
    * up and choosing the minimum of the two delays when both of the schedules want to delay the
    * next retry. The dual of the `join` operation.
    */
